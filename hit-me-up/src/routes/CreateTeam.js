...
class CreateTeam extends React.Component {
  ...
  render() {
    ...
    return (
    <body style={{display: "flex", justifyContent:"center", alignItems:"center", width: "100vw", height: "100vh", backgroundImage:"url(https://data.whicdn.com/images/202987458/original.gif)", backgroundSize:"cover"}}>
